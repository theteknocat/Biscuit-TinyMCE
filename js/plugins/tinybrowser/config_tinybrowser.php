...
if (method_exists($Authenticator,'user_upload_path')) {
	...
	$tinybrowser['path']['image'] = '/var'.$Authenticator->user_upload_path('image'); // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
	$tinybrowser['path']['media'] = '/var'.$Authenticator->user_upload_path('media'); // Media files location
	$tinybrowser['path']['file']  = '/var'.$Authenticator->user_upload_path('file'); // Other files location
} else if (defined('TINYBROWSER_UPLOAD_PATH')) {
	$tinybrowser['path']['image'] = '/var'.TINYBROWSER_UPLOAD_PATH; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
	$tinybrowser['path']['media'] = '/var'.TINYBROWSER_UPLOAD_PATH; // Media files location
	$tinybrowser['path']['file']  = '/var'.TINYBROWSER_UPLOAD_PATH; // Other files location
} else {
	$tinybrowser['path']['image'] = '/var/uploads/images/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
	$tinybrowser['path']['media'] = '/var/uploads/media/'; // Media files location
	$tinybrowser['path']['file']  = '/var/uploads/files/'; // Other files location
}
